...
void RotateGizmo::createGizmos(std::string axisName)
{
    ...
    {
        if (axisName == "X")
            linePoints.push_back(Vector3(0, cos(i / 32.0 * pi), sin(i / 32.0 * pi)) * radius);
        if (axisName == "Y")
            linePoints.push_back(Vector3(cos(i / 32.0 * pi), 0, sin(i / 32.0 * pi)) * radius);
        if (axisName == "Z" || axisName == "E" || axisName == "XYZE")
            linePoints.push_back(Vector3(sin(i / 32.0 * pi), cos(i / 32.0 * pi), 0) * radius);
    }
    // handles
