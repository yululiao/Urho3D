...
void ImGui::Image(int user_texture_id, const ImVec2& size)//, const ImVec2& uv0, const ImVec2& uv1, const ImVec4& tint_col,const ImVec4& border_col)
{
    ImGui::Image((void*)(long long)user_texture_id, size);
}
...
bool ImGui::ImageButton(int user_texture_id, const ImVec2& size)
{
    return ImageButton((void*)(long long)user_texture_id, size);
